package com.monsterbutt.homeview.data;
...
public final class VideoContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.monsterbutt.homeview.provider.MediaContentProvider";
    ...
    public static final class VideoEntry implements BaseColumns {
        ...
        public static final String COLUMN_SERVERPATH = "serverPath";
        public static final String COLUMN_WATCHEDOFFSET = "watchedOffset";
        public static final String COLUMN_WATCHED = "watched";
        public static final String COLUMN_SHOULDSTART = "shouldstartinqueue";

        // The action intent for the result.
        public static final String COLUMN_ACTION = SearchManager.SUGGEST_COLUMN_INTENT_ACTION;

        public static final String COLUMN_DATA_ID = SearchManager.SUGGEST_COLUMN_INTENT_DATA_ID;
        public static final String COLUMN_EXTRA = SearchManager.SUGGEST_COLUMN_INTENT_EXTRA_DATA;
