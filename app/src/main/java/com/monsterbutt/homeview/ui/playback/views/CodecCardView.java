...
public class CodecCardView extends BaseCardView {
    ...
    public CodecCardView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mImageViewA = findViewById(R.id.imageA);
        mImageViewB = findViewById(R.id.imageB);
        mTitleView = findViewById(R.id.main_text);
        mSubtitleView = findViewById(R.id.sub_text);
        mDecoderView = findViewById(R.id.decode_text);
        mTracksFlag = findViewById(R.id.flag_image);
        mTrackCount = findViewById(R.id.flag_text);
    }
    ...
    public boolean isSubtitleTextEmpty() {
      return mSubtitleView == null || mSubtitleView.getText().toString().isEmpty();
    }
    ...
    public void clearSecondaryImage() {
        setSecondaryImage(null, true);
    }
