...
public class SelectionFragment extends DetailsFragment {
  ...
  public SelectionFragment(ListRow row, OnItemViewClickedListener listener,
    ...
    presenterSelector.addClassPresenter(ListRow.class, new SelectionListRowPresenter());
  ...
  private class SelectionListRowPresenter extends ListRowPresenter {
