...
import static com.monsterbutt.homeview.ui.main.tasks.ServerCheckTask.ALLOW_CREDENTIAL_SIGNIN;
import static com.monsterbutt.homeview.ui.main.tasks.ServerCheckTask.PICK_CREDENTIALS;
...
public class ServerLoginDialog {
  ...
  public interface ServerLoginInterface {
    ...
    void setCredentialProcessor(ServerCheckTask.CredentialProcessor processor, final Credential credential);
  }

  private final ServerLoginInterface callback;

  public ServerLoginDialog(ServerLoginInterface callback) {
    this.callback = callback;
  }

  public void login(FragmentActivity activity, final PlexServer server) {
  ...
  private void login(final GoogleAuthTask authTask, final Activity activity,
    ...
    final EditText login = dialogView.findViewById(R.id.edit_plex_login);
    final EditText pass = dialogView.findViewById(R.id.edit_plex_pass);
  ...
  private static class GoogleAuthTask extends AsyncTask<Void, Void, Void>
   implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,
   ServerCheckTask.CredentialProcessor {
