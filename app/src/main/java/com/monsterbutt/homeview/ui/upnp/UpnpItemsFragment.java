package com.monsterbutt.homeview.ui.upnp;
...
import com.monsterbutt.homeview.ui.presenters.UpnpCardPresenter;
...
public class UpnpItemsFragment extends VerticalGridFragment implements ICardSelectionListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(mPathName);
        mSelectionHandler = new SelectionHandler(this, this);
    ...
    private class BrowseCallback extends Browse {
        ...
        BrowseCallback(Service service, String containerId, BrowseFlag flag) {
            ...
            if (items != null && !items.isEmpty()) {
                ...
                for (Item item : items) {
                    ...
                    if (!Character.isAlphabetic(titleLetter.charAt(0)))
                        titleLetter = QuickJumpRow.NUM_OR_SYMBOL;
                    else
