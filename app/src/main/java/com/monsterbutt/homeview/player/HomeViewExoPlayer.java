...
public final class HomeViewExoPlayer implements ExoPlayer {
    ...
    private void buildRenderers(Context context,
        ...
        mAudioRenderer = new DeviceAudioTrackRenderer(MediaCodecSelector.DEFAULT,
                ...
                AudioManager.STREAM_MUSIC, MediaCodecCapabilities.getInstance(context));
        renderersList.add(mAudioRenderer);

        Renderer textRenderer = new TextRenderer(componentListener, mainHandler.getLooper(),
                                                HomeViewSubtitleDecoderFactory.DEFAULT);
    ...
    private final class ComponentListener implements VideoRendererEventListener,
        ...
        public void onRenderedFirstFrame(Surface surface) {
            if (videoListener != null && HomeViewExoPlayer.this.surface == surface) {
        ...
        public void onTrackSelectionsChanged(TrackSelections<?> trackSelections) {
            ...
            if (videoListener != null && HomeViewExoPlayer.this.videoTracksEnabled && !videoTracksEnabled) {
                videoListener.onVideoTracksDisabled();
            }
            HomeViewExoPlayer.this.videoTracksEnabled = videoTracksEnabled;
        }
