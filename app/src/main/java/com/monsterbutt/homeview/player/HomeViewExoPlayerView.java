 ...
 */
@TargetApi(16)
public final class HomeViewExoPlayerView extends FrameLayout {
    ...
    public HomeViewExoPlayerView(Context context) {
        this(context, null);
    }

    public HomeViewExoPlayerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HomeViewExoPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     */
    public HomeViewExoPlayer getPlayer() {
        return player;
    }
     ...
     */
    public void setPlayer(HomeViewExoPlayer player) {
    ...
    private final class ComponentListener implements HomeViewExoPlayer.VideoListener,
