...
public final class ExoPlayerFactory {
    ...
    /**
     * Creates a {@link HomeViewExoPlayer} instance. Must be called from a thread that has an associated
     * {@link Looper}.
     *
     ...
     */
    public static HomeViewExoPlayer newHomeViewInstance(Context context, TrackSelector<?> trackSelector,
                                                    LoadControl loadControl) {
        return newHomeViewInstance(context, trackSelector, loadControl, null);
    }
    ...
    public static HomeViewExoPlayer newHomeViewInstance(Context context, TrackSelector<?> trackSelector,
        ...
        return newHomeViewInstance(context, trackSelector, loadControl, drmSessionManager, false);
    }
    ...
    public static HomeViewExoPlayer newHomeViewInstance(Context context, TrackSelector<?> trackSelector,
        ...
        return newHomeViewInstance(context, trackSelector, loadControl, drmSessionManager,
    ...
    public static HomeViewExoPlayer newHomeViewInstance(Context context, TrackSelector<?> trackSelector,
        ...
        return new HomeViewExoPlayer(context, trackSelector, loadControl, drmSessionManager,
