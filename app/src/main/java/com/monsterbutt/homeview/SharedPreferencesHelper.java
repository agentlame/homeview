...
public final class SharedPreferencesHelper {
  ...
  private static final String TAG = "HV_SharedPrefHandler";

  private static final String PREFS_NAME = "com.monsterbutt.homeview.tv.recommendations";
  private static final String PREFS_SUBSCRIPTIONS_KEY =
   "com.monsterbutt.homeview.tv.recommendations.prefs.SUBSCRIPTIONS";
  private static final String PREFS_SUBSCRIBED_MOVIES_PREFIX =
   "com.monsterbutt.homeview.tv.recommendations.prefs.SUBSCRIBED_MOVIES_";
   ...
   */
  public static List<Video> readMovies(Context context, long channelId) {
   ...
   */
  public static void storeMovies(Context context, long channelId, List<Video> movies) {
